...
export const HeroSection = ({
  ...
  const videoSource =
    backgroundVideoUrl ||
    (!backgroundImageUrl
      ? "https://0o3lgk0frc.ufs.sh/f/hPValf4qdHVn80LQcDC6XJqKmpzwTuogRvIMcBs2hkj9QWnU"
      : undefined);
    ...
    >
      {videoSource ? (
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1 }}
          className="absolute top-0 left-0 w-full h-full bg-center bg-cover blur-md brightness-[0.2]"
