...
import { ArrowUpRight, Calendar, CheckCircle, Clock, DollarSign, Plus, TrendingUp, Users } from "lucide-react";
...
export default function DashboardPage() {
  return (
    <main className="flex-1 overflow-y-auto p-6">
          {/* Welcome Section */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground font-sans mb-2">Welcome back, John!</h2>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Mike Chen - 15 minutes ago</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">$150 from Alex Rodriguez - 1 hour ago</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">with Emma Wilson</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">with David Park</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge variant="outline">
                ...
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">with Lisa Zhang</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge variant="outline">
